...
Ask the user: "Describe the problem you're facing. What is the error? When did it start? What did you expect to happen?"
...
2. **Expected behavior:**
   ...
   - Ask when it last worked correctly.
...
2. **Recent Changes:**
   ...
   ```
   - Recent commits, deployments, config changes, dependency updates
...
**Between each phase:**
> Ask the user: "Phase [X] complete. Document generated. Proceed to the next phase?"

**Before implementing a fix:**
> Ask the user: "Root cause identified: [description]. Implement the fix?"

**After the fix:**
> Ask the user: "Fix applied. Validate that the issue is resolved?"
