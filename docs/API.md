...
| CLI | `openkit upgrade` | `rust-cli/src/main.rs` | Rust-native self-update on Linux/macOS (checksum + atomic swap, optional minisign validation via `OPENKIT_MINISIGN_PUBKEY`); installer flow on Windows. |
